...
export async function createEmailCode(email: string, purpose: CodePurpose, ttlMinutes = 15) {
...
export async function verifyEmailCode(email: string, purpose: CodePurpose, code: string): Promise<boolean> {
