      ...
      <header className="sticky top-0 z-40 border-b border-border/70 bg-card/92 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-3">
            ...
            <span className="hidden rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary sm:inline-flex">Responsável pelo animal</span>
            <ThemeToggle />
            <button
              type="button"
              onClick={openHelp}
          ...
          {currentUserType === 'owner' ? (
            <div className="mb-4 flex items-center justify-between gap-3 rounded-[20px] border border-primary/25 bg-primary/5 px-4 py-3">
              ...
              <button
                ...
                className="inline-flex min-h-11 shrink-0 items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-xs text-foreground transition-colors hover:bg-muted"
              >
