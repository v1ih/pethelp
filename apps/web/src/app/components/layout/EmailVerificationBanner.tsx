...
export default function EmailVerificationBanner() {
  ...
  return (
    <div className="mb-4 rounded-2xl border border-amber-300/60 bg-amber-50 p-4 text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
      ...
      {open ? (
        <form onSubmit={handleVerify} className="mt-3 flex flex-wrap items-center gap-2">
          <input
            ...
            className="w-44 rounded-xl border border-amber-300 bg-white/80 px-3 py-2 text-sm tracking-widest text-amber-900 outline-none focus:border-amber-500 dark:border-amber-500/40 dark:bg-transparent dark:text-amber-100"
          />
          <button
            type="submit"
            disabled={busy}
